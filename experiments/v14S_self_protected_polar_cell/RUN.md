...
Dependencies: Python 3, NumPy, SciPy. No SPICE compact model is used for the new HZO/inhibit/guided-gap compound device. The real capacitance input is the inherited v14R Magic/SKY130 extraction stored under `inherited/`.

The historical v12S transistor-count comparison is documented in `REPORT.md`; it is not required for the main v14S rerun.
